...
/subgoal [text|sub]  Append criteria to active goal without resetting the loop
                     (subcommands: remove N, clear)
...
| File | Contents |
|------|----------|
| `references/persistent-goals.md` | Full docs on `/goal` and `/subgoal` features |
| `references/execute-code-sandbox-env-windows.md` | Windows sandbox env diagnostic recipe |
| `references/prompt-builder-environment-hints.md` | Environment hints injection design + testing |
