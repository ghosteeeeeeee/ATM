...
## Renamed Sources Session Log (2026-04-28)
- `em20-long` → `em2050-` | `em20-short` → `em2050+` (rename only, no direction change)
...
- **SWAP** (2026-04-28): `gap-300+` ↔ `gap-300-` — gap-300+ now fires SHORT, gap-300- now fires LONG
  - T asked to flip both labels simultaneously (swap, not sequential rename)
  - Updated SOURCE_LONG/SOURCE_SHORT in gap300_signals.py AND SIGNAL_SOURCE_WEIGHTS in signal_compactor.py
