...
SNIPER_HYSTERESIS_SCORE = 90        # continuum score above this = trend intact, suppress BEARISH exits
...
PUMP_FLOW_MAX_POSITIONS = 4            # max concurrent pump-chain positions (bumped from 2, 2026-09-14)
