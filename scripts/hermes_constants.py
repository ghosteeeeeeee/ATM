...
PROFIT_MONSTER_BYPASS_SIGNALS = (
    ...
    # trend_purity: NOT bypassed — uses pm_trail + atr_sl (default)
...
SIGNAL_EXIT_CONFIG = {
    ...
    'accel-300-v3-short-': 'rr_engine',
    'accel-300-v3-short': 'rr_engine',
    # Trend purity: NOT in SIGNAL_EXIT_CONFIG — uses pm_trail + atr_sl (default)
...
PUMP_FLOW_PLUS_ENABLED = False        # KILLED 2026-09-11 15:10 — 12T/24h 25%WR -$0.88. ALL NEUTRAL. 75% losers. Was logged killed at 13:15 but never applied.
