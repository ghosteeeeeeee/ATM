...
ACCEL_300_V2_SHORT_MIN_GAP = 0.7    # SHORT: min gap below EMA300 (filters marginal losers, keeps winners)
ACCEL_300_V2_SHORT_MAX_GAP = 2.0    # SHORT: max gap (smaller range for SHORT)
