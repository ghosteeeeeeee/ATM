...
BB_BOUNCE_PLUS_ENABLED = True  # AUTO-ROTATED 2026-08-20 # RE-ENABLED 2026-08-17 per user. Part of winning LONG streaks.
...
TREND_FILTER_NEUTRAL_PCT = 0.2807 # EMA spread % for neutral zone — narrowed from 0.5 by self_learner (more restrictive)
