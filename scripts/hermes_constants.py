...
R2_TREND_LONG_MIN_PRE_MOVE = 0.2     # min pre-entry move % — block LONG when price dropping before entry (dead-cat bounces). RAISED 2026-08-18 from 0.1 — r2-trend-long3 10T/7d ATR_SL avg peak +0.11% (below PM_TRAIL 0.4% activation). RAISED 2026-08-15 from 0.0.
