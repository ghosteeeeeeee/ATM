...
MOMENTUM_LEADERBOARD_OVEREXTENDED_PCT = 3.0   # % — fade opposing signal when abs(ret_5m) exceeds this
...
MOMENTUM_LEADERBOARD_CONF_BASE = 75           # base confidence before bonuses/penalties
MOMENTUM_LEADERBOARD_CONF_FLOOR = 50          # minimum confidence
MOMENTUM_LEADERBOARD_CONF_CAP = 88            # maximum confidence (matches system ceiling)
