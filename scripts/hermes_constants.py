...
ACCEL_300_V3_LONG_ENABLED      = False   # CEO 2026-09-02 — 14T/24h 42.9% WR -$0.51, ALL ATR_SL. #1 loss source. Pullback entries not working in current market.
...
ACCEL_300_V3_LONG_MIN_PULLBACK = 0.20   # min gap narrowing from peak — price must have retraced (raised from 0.15: blocks shallow pullbacks like SUSHI at 0.00%)
