...
ATR_TP_K_MULT          = 1.5    # TP = 1.5x SL (asymmetric R:R — target larger wins, trailing handles profit-taking)
...
PM_TRAIL_DISTANCE_PCT = 0.20  # trail 0.20% behind peak (backtested optimal for wave_catcher)
