...
MA_100_CROSS_MINUS_ENABLED = True     # Re-enabled 2026-08-08 — new ma_100_cross_short.py with tighter params
...
MOMENTUM_LEADERBOARD_MOVE_MIN = 3.0           # min move_score % — only real movers (was 1.0, too noisy)
