...
TRAILING_ACTIVATION_PCT = 0.0035  # 0.35% — trailing activates when trade hits +0.35%
TRAILING_DISTANCE_PCT   = 0.0060  # 0.60% — trailing SL distance from peak (was 0.20%, too tight = premature exits)
...
PM_TRAIL_ACTIVATE_PCT = 0.35  # mark trade as "in profit" at this threshold — activate trailing sooner to lock more profit
PM_TRAIL_DISTANCE_PCT = 0.15  # trail 0.25% behind peak (widened from 0.15 — 0.15% triggered on normal wicks)
...
RANGE_BREAKOUT_PLUS_ENABLED = False  # CEO 2026-08-12 — 7T -$0.30 28.6% WR. range_breakout- SHORT profitable (5T +$0.41 100%).
