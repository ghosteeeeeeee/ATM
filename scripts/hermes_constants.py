...
BB_BOUNCE_PLUS_ENABLED = False  # AUTO-ROTATED 2026-08-17  # AUTO-ROTATED 2026-08-17   # RE-ENABLED 2026-08-17 per user. Part of winning LONG streaks.
...
TREND_FILTER_NEUTRAL_PCT = 0.2425 # EMA spread % for neutral zone — narrowed from 0.5 by self_learner (more restrictive)
