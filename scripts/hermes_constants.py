...
NEVER_REENABLE_FLAGS = {
    ...
    'SLOW_GRIND_SHORT_ENABLED',     # CEO KILLED 2026-08-26 — 8T/24h 37.5% WR -$0.34, inverted R:R. NEVER_REENABLE.
}
...
SLOW_GRIND_SHORT_ENABLED = False   # CEO KILLED 2026-08-26 — 8T/24h 37.5% WR -$0.34, inverted R:R (big losses, small wins)
