...
SLOW_GRIND_SHORT_ENABLED = True    # TESTING — new filters: MAX_DECLINE_FROM_HIGH=1.5%, velocity, RSI tightened. Monitor WR.
...
ACCEL_300_V2_SHORT_MIN_GAP = 0.3    # SHORT: min gap below EMA300 (lower than LONG)
