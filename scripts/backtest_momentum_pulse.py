#!/usr/bin/env python3
"""
backtest_momentum_pulse.py — Momentum Pulse Signal Backtester (Optimized)

Tests the proposed momentum pulse signal rules:
Entry:
...
Exit:
  ...
  - Time exit: 60 candles (1 hour)

Usage:
  python3 backtest_momentum_pulse.py --tokens TURBO DOGE ENA ETH BTC
  python3 backtest_momentum_pulse.py --top 10
  python3 backtest_momentum_pulse.py --all
"""
...
parser = argparse.ArgumentParser(description='Momentum Pulse Signal Backtester')
parser.add_argument('--tokens', nargs='+', default=None)
parser.add_argument('--top', type=int, default=None)
parser.add_argument('--all', action='store_true', help='Test all tokens with enough data')
parser.add_argument('--min-candles', type=int, default=1000)
...
parser.add_argument('--cooldown', type=int, default=30, help='Cooldown candles between entries (default: 30)')
...
def sma(values, period):
    ...
    Skips None values in the input (they represent insufficient data)."""
...
def main():
    ...
    print(f'Momentum Pulse Backtest — {len(tokens)} tokens')
