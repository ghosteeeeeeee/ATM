    ...
    with FileLock('signal_compactor_critical'):
        ...
        for row in rows:
            ...
            if not CONFLUENCE_REQUIRED:
                ...
                # PM Trail bypass: signals with pm_trail exit bypass confluence
                elif bare_src in PM_TRAIL_BYPASS_SIGNALS:
                    pass_gate = True
                    gate_msg = f'NEUTRAL-relax: pm_trail bypass ({bare_src})'
                else:
