...
FAMILY_MAP = {
    ...
    'Squeeze': ['squeeze_cross', 'bollinger_squeeze_long', 'bollinger_squeeze_short', 'atr_compression',
                'squeeze_reversal_long', 'squeeze_reversal_short'],
    'Grind_Breakout': ['grind_breakout_long', 'grind_breakout_short', 'grind-breakout', 'grindbreakout'],
    'Trendline': ['tl_break', 'tl_break_long', 'tl_break_short', 'vortex_break_long', 'vortex_break_short'],
    'Mover': ['mover_long', 'mover_short', 'mover', 'coin_tracker_hot_long', 'coin_tracker_hot_short', 'coin_tracker_hot'],
    'Pattern': ['pattern_wolf', 'pattern_micro_flag', 'pattern_channel_long', 'pattern_channel_short',
                 'hh_hl_choch', 'hh_hl_breakout', 'hh_hl_breakout_long', 'hh_hl_breakout_short',
    ...
    'Volume': ['volume_hl', 'pump_catcher_long', 'volume_breakout_long', 'volume_breakout_short',
               'volume-breakout-long', 'volume-breakout-long+', 'volume-breakout-short', 'volume-breakout-short+'],
    'ATR': ['atr_spike_long'],
