...
from hermes_constants import (
    ...
    COILED_SPRING_TRIGGER_LONG_RSI_BONUS_MIN,
    COILED_SPRING_TRIGGER_LONG_RSI_BONUS_MAX,
...
def detect_coiled_spring_trigger(rows):
    ...
    if COILED_SPRING_TRIGGER_LONG_RSI_BONUS_MIN <= rsi_now <= COILED_SPRING_TRIGGER_LONG_RSI_BONUS_MAX:
        confidence += 3
