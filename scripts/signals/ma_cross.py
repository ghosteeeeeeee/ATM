# Migrated from ../ma_cross_signals.py — see signals/__init__.py registry
#!/usr/bin/env python3
"""
...
def scan_ma_cross_signals(prices_dict: dict) -> list:
    ...
    for token, data in prices_dict.items():
        ...
        if sig['direction'] == 'LONG' and not MA_CROSS_PLUS_ENABLED:
            continue
        if sig['direction'] == 'SHORT' and not MA_CROSS_MINUS_ENABLED:
            continue
...
def run(prices_dict=None):
    ...
    result = scan_ma_cross_signals(prices_dict)
