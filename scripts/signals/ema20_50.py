...
# em20-long / em20-short renamed 2026-04-28
# em2050+: LONG signal (bullish pullback) | em2050-: SHORT signal (bearish pullback)
SOURCE_LONG       = 'em2050-'
SOURCE_SHORT      = 'em2050+'
...
def _detect_one_direction(
    ...
    for j in range(3, len(closes) - 1):
        ...
        source   = SOURCE_SHORT      if direction == 'LONG' else SOURCE_LONG
