# Migrated from ../macd_1m_signals.py — see signals/__init__.py registry
"""
            ...
            if len(closes) >= ss + sg_s + 2:
                ...
                if h_s and len(h_s) >= 2:
                    ...
                    if h_prev_s >= 0 > h_cur_s:
                        ...
                        from hermes_constants import MACD_1M_PLUS_ENABLED, MACD_1M_MINUS_ENABLED
                        if not MACD_1M_MINUS_ENABLED:
                            continue
...
def run(prices_dict=None):
    ...
    return scan_macd_1m_signals(prices_dict)
