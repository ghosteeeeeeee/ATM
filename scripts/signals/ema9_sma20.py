# Migrated from ../ema9_sma20_signals.py — see signals/__init__.py registry
#!/usr/bin/env python3
"""
...
def scan_ema9_sma20_signals(prices_dict: dict) -> int:
    from hermes_constants import EMA9_SMA20_ENABLED
    if not EMA9_SMA20_ENABLED:
        return 0
    """
    ...
    for token, data in prices_dict.items():
        ...
        try:
            ...
            from hermes_constants import EMA9_SMA20_PLUS_ENABLED, EMA9_SMA20_MINUS_ENABLED
            if direction == 'LONG' and not EMA9_SMA20_PLUS_ENABLED:
                continue
            if direction == 'SHORT' and not EMA9_SMA20_MINUS_ENABLED:
                continue
...
def run(prices_dict=None):
    ...
    return scan_ema9_sma20_signals(prices_dict)
