...
try:
    from signals.accel_300 import run as _accel_300_run
except Exception:
    _accel_300_run = None
...
try:
    from signals.pump_chain_v5 import run as _pump_chain_v5_run
except Exception:
    _pump_chain_v5_run = None

try:
    from signals.pump_chain_v5_short import run as _pump_chain_v5_short_run
except Exception:
    _pump_chain_v5_short_run = None
...
try:
    from signals.continuum_ma import run as _continuum_ma_run
except Exception:
    _continuum_ma_run = None
...
SIGNAL_REGISTRY: list[dict] = [
    ...
    {'name': 'accel_300_short',          'enabled': ACCEL_300_MINUS_ENABLED,       'run': _accel_300_run},
    ...
    {'name': 'continuum_ma',              'enabled': 'CONTINUUM_MA_ENABLED',          'run': _continuum_ma_run},
