...
## [2026-08-11 18:28] Hourly Analysis

**Trades:** 2 closed last hour (2W, 0L) — net +$0.05
**24h:** 26T 9W (34.6% WR) -$0.60
**7d:** 372T 193W (51.9% WR) +$0.26

**SL Hit Rate:**
- 24h: 53.8% (14/26) — elevated, above 40% threshold
- Eval window closes 05:20 Aug 12 (~11h)

**Signal Performance (24h):**
- bb_bounce+,hzscore+: 7T 14.3% WR -$0.21 — dominant but cold (7d: 33T 48.5% WR +$0.20 intact)
- hzscore+: 4T 50% WR -$0.06
- trend_momentum_near_sma+: 3T 0% WR -$0.35 — KILLED (contrarian flip ineffective)
- hzscore-,range_breakout-: 2T 100% WR +$0.10 — best signal

**Last Hour Trades:**
- AVNT hzscore+ WIN +$0.02 (profit-monster-trail)
- JUP hzscore- WIN +$0.03 (profit-monster-trail)

**Changes:**
1. DISABLED TREND_MOMENTUM_NEAR_SMA_ENABLED=False, PLUS/MINUS=False — 0% WR (3T -$0.35 6h), contrarian flip in signal_compactor.py ineffective. CEO previously killed this signal; was re-enabled without backtest. Killing again.

**No Change Needed:**
- Eval window active until 05:20 Aug 12 — no param changes
- bb_bounce+,hzscore+ 7d intact (48.5% WR) — cold streak within normal variance
- Trade frequency normal (2/hr)
- 7d system profitable (51.9% WR +$0.26)
- No overtrading

**Open Questions:**
- Eval window closes ~11h — atr_sl_hit 53.8% needs tuning after window
- bb_bounce+,hzscore+ 24h 14.3% WR cold streak — if persists after eval window, may need signal-specific tuning
