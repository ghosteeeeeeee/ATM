...
4. **brain_auditor ~11:50 UTC — CONFIG CHANGE.** DB: 24h 28T 50.0%WR -$0.17. 7d: 286T 53.5%WR +$0.19. Market NEUTRAL. **BB DEAD ZONE FILTER DEPLOYED.** SHORT_BB_DEAD_ZONE_MIN=0.70, SHORT_BB_DEAD_ZONE_MAX=0.85. 7d: BB 0.70-0.85 SHORT 17T 41.2%WR -$1.05. Other zones 162T 57.8%WR +$3.77. Blocks 7 losers (-$0.94), 7 winners (+$0.42). Net: +$0.52/7d. **LOSING TRADE AUTOPSY (24h 14T losses):** pullback-entry- 8 SHORT (25%WR -$0.67, normal variance for 58.5%WR signal). rr-struct-v2+ 3 LONG (57%WR -$0.25, small sample, all ATR SL). pump-chain- 2 SHORT (near breakeven). breakout-long+ 1 LONG (-$0.18). **MONITORING:** rr_engine_resistance 6T/48h +$0.06, ATR_SL 55.5% below-entry, SHORT_NORMAL_PENALTY 0 trades in 30h, trend_ignition 0 trades, rr-struct-v2+ LONG 9T/7d all ATR SL.
...
- **SHORT BB DEAD ZONE (0.70-0.85).** DEPLOYED. 17T 7d 41.2%WR -$1.05. Expected +$0.52/7d. — 2026-09-15 ~11:50 UTC
