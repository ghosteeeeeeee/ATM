...
**Current status:** System STRONG — 24h +$0.64, 59.5% WR (BEST IN DAYS). 48h +$0.28, 49.5% WR (positive). PM_TRAIL 39T 84.6% WR +$1.85 (DOMINANT, 0.46% avg win). ATR_SL 33T -$2.03 (stable, daily 41→33). R:R 0.87:1. ct-hot+ 33T/48h -$0.42 (user TESTING MODE, clears Aug 17-18). 2 open LONG ~flat. 7d: 430T -$2.10, 49.1% WR. Aug 17: 9T +$0.53, 77.8% WR (STRONG). Market NEUTRAL (106 tokens, 3 accumulation). Stars7d: return_exhaustion_long 4T 100% +$0.43, bb_bounce+ 24T 58.3% +$0.21, r2-trend-long2 17T 64.7% +$0.19.
...
3. **24h STRONG.** +$0.64, 59.5% WR (best in days). — 2026-08-17
4. **48h positive.** +$0.28, 49.5% WR. — 2026-08-17
5. **ATR_SL daily improving.** 33/day (from peak 41). SPEED_MIN 40 working. — 2026-08-17
