...
**Last Updated: 2026-08-20 21:00 UTC (CEO run)**
**Updated by: CEO**
...
**Current status:** System HEALTHY — 24h 28T -$0.02, 60.7% WR (flat, second red-ish day after 8+ green — normal variance). 7d: 279T -$1.59, 50.5% WR. PM_TRAIL DOMINANT: 149T/7d +$5.75, 83.9% WR (carrying system). ATR_SL: 103T/7d -$7.88, 1.0% WR (historic low). Aug 20: 12T -$0.54, 41.7% WR (SHORT legacy clearing + stop_hunt drag). LONG side today: 9T -$0.07 (stop_hunt 6T 50% -$0.10 dragging, r2-trend-long4 4T 100% +$0.23 strong). 1 open (CAKE r2-trend-long3 flat). stop_hunt_reversal_long+: 10T/7d 60% -$0.04 (break-even, 48h deteriorating). r2-trend-long3: 31T/7d 58.1% -$0.14 (MIN_PRE_MOVE 0.3 eval wraps Aug 21). Conf-filter: CONF_FILTER_ENABLED=True, CONF_FILTER_MAX=89, TIME_BLOCK_ENABLED=True (01-06 UTC). 90+ tier blocked.
